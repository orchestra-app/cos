...
- **v8 → v9 — the unanswered-messages fields** (`MessageRecord.needsAnswer?` / `answeredAt?` /
  ...
  and `context` (the one-sentence line shown in the view). **Purely additive + back-compatible:** old v8
