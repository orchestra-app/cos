...
const SCHEMA_VERSION = 9; // v9 — board/lib/types.ts SCHEMA_VERSION (MessageRecord.needsAnswer/answeredAt/context; additive optional, old v8 files read unchanged)
